...
public class UserController extends BaseController {
    ...
    public Result doSet(User user) {
        ...
        user.setSign(HtmlUtils.htmlEscape(user.getSign()));
        //敏感词过滤
        temp.setUsername(sensitiveFilter.filter(user.getUsername()));
        temp.setSign(sensitiveFilter.filter(user.getSign()));
